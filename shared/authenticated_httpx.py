        ...
        def auth_flow(self, request):
            ...
            if not id_token:
                try:
                    ...
                    # Alternatively, fetch id token credentials if available via ADC
            ...
            if not id_token:
                # Local run, fetching authenticated user's identity token from gcloud CLI
                try:
                    ...
                    print("ERROR: Unable to fetch identity token via gcloud CLI.")
